...
export const SERIES_QUESTIONS: GlobalQuestion[] = [
  ...
  { id: 6, category: "Series", question: "The harmonic series Σ(1/n) converges.", correctAnswer: true, explanation: "The harmonic series diverges despite lim(n→∞) 1/n = 0, which is proven by the integral test or Cauchy condensation test." },
